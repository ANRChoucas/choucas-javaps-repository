...
/**
 * This WPS process is an adapter for Erig Ner Service.
 *
...
public class ErigNer{

	// private static final Logger log = LoggerFactory.getLogger(ErigNer.class);
    ...
    public void run() {
        ...
        if (content != null) {
		  ...
		  try {
			  System.out.println("\n" + separator);
			  System.out.println("Adapter : Calling Ner...");
    ...
    protected static String callNERC(String api_url, String api_key, String lang, String content) throws IOException
    {
    		api_url += "/PERDIDO/api/ner/txt_xml/";
