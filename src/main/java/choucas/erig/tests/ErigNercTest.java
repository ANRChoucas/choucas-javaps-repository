...
public class ErigNercTest 
{
    public static void main( String[] args )
    {
    	ErigNerc service = new ErigNerc();
        ...
        System.out.println( "--------------------------------" );
        System.out.println( "Test : Calling Erig Nerc Service" );
        service.run();
        System.out.println( "\n--------------------------------------");
        System.out.println( "Test: Result of Erig Nerc Service\n\n" + service.getDataOutput());       
